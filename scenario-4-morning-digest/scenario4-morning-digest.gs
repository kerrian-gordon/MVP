...
// plain-text summary to Slack.
//
// COLUMN CONTRACT
//   READ:   CANDIDATE, ROLE, DEPARTMENT, STAGE, INTERVIEW DATE, INTERVIEWER,
//           ROUND, REFERRED BY, UPDATED
//   WRITE:  none — this scenario never writes to the Tracker
// Accuracy is entirely inherited from Scenarios 1–3. If this script is ever
// changed to write back to the Tracker, that breaks the "pure reader"
// property the whole pipeline design depends on — treat that as a design
// decision to revisit, not a small addition.
