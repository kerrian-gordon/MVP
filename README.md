...
| 2. Calendar sync | [`scenario-2-calendar-sync/`](scenario-2-calendar-sync/) | ⬜ Not started |
...
- Build out Scenarios 2–4 following the same MVP-first approach: prove the core logic standalone before connecting it to any live system.
